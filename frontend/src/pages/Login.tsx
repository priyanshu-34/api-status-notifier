  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-[#0f0f12]">
      <div className="w-full max-w-[360px] rounded-lg border border-[#27272a] bg-[#18181b] p-6">
        ...
        <p className="text-sm text-[#a1a1aa] mb-6">Log in to your account</p>
        {error && <p className="text-sm text-red-400 mb-4">{error}</p>}
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="login-email" className="block text-sm font-medium text-[#a1a1aa] mb-1">
              Email
            </label>
            <input
              id="login-email"
          ...
          <div>
            <label htmlFor="login-password" className="block text-sm font-medium text-[#a1a1aa] mb-1">
              Password
            </label>
            <input
              id="login-password"
